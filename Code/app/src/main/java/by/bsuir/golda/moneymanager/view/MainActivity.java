...
import by.bsuir.golda.moneymanager.view.AccountActivity;
import by.bsuir.golda.moneymanager.view.TransactionActivity;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_account) {
            ...
            startActivity(intent);
        } else if (id == R.id.nav_transaction_plan) {
